...
- No `8.6.0-dev` in `require.php` (leftover artifact elsewhere; not adopted here).

### V. Naming

- Never repeat the namespace in class or interface names. `Webware\Mailer` namespace has
  `MailerInterface`, not `MailerMailerInterface`. Applies to all new code.
